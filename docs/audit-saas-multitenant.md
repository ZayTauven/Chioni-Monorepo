...
5. **Le KYC ne bloque que le rail diaspora** — un centre non vérifié (ou « suspendu ») facture, encaisse au guichet, tient sa caisse et émet des reçus « G- » sans restriction (`record_cash_payment` s'en dispense explicitement). *Décision produit à prendre : que doit réellement fermer une suspension ?*
